...
public:
	...
	*/
	...
	TiXmlText(bool initValue) : TiXmlNode(TiXmlNode::TEXT)
	{
		int value = initValue?1:0;
		char result[128];
		sprintf_s(result,128, "%d", value);
		SetValue(result);
		cdata = false;
	}
	TiXmlText(int initValue) : TiXmlNode(TiXmlNode::TEXT)
	{
		
		char result[128];
		sprintf_s(result,128, "%d", initValue);
		SetValue(result);
		cdata = false;
	}
	TiXmlText(double initValue) : TiXmlNode(TiXmlNode::TEXT)
	{
